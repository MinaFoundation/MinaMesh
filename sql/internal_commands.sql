...
FROM internal_commands_cte AS ic
LEFT JOIN internal_commands_cte AS ic_coinbase_receiver
    ON
        ic.command_type = 'fee_transfer_via_coinbase'
        AND ic_coinbase_receiver.command_type = 'coinbase'
LEFT JOIN
    public_keys AS coinbase_receiver_pk
