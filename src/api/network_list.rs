use anyhow::Result;
use coinbase_mesh::models::{NetworkIdentifier, NetworkListResponse, NetworkRequest};
...
impl MinaMesh {
  pub async fn network_list(&mut self, req: NetworkRequest) -> Result<NetworkListResponse> {
