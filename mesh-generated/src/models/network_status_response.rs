...
pub struct NetworkStatusResponse {
    ...
    pub current_block_identifier: Box<models::BlockIdentifier>,
    ...
    pub genesis_block_identifier: Box<models::BlockIdentifier>,
    #[serde(rename = "oldest_block_identifier", skip_serializing_if = "Option::is_none")]
    pub oldest_block_identifier: Option<Box<models::BlockIdentifier>>,
    #[serde(rename = "sync_status", skip_serializing_if = "Option::is_none")]
    pub sync_status: Option<Box<models::SyncStatus>>,
...
impl NetworkStatusResponse {
    ...
    pub fn new(current_block_identifier: models::BlockIdentifier, current_block_timestamp: i64, genesis_block_identifier: models::BlockIdentifier) -> NetworkStatusResponse {
        NetworkStatusResponse {
