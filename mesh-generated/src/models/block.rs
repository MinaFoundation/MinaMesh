...
pub struct Block {
    ...
    pub parent_block_identifier: Box<models::BlockIdentifier>,
...
impl Block {
    ...
    pub fn new(block_identifier: models::BlockIdentifier, parent_block_identifier: models::BlockIdentifier, timestamp: i64, transactions: Vec<models::Transaction>) -> Block {
        Block {
