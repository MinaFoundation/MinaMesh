...
impl BlockTransactionRequest {
    ...
    pub fn new(network_identifier: models::NetworkIdentifier, block_identifier: models::BlockIdentifier, transaction_identifier: models::TransactionIdentifier) -> BlockTransactionRequest {
