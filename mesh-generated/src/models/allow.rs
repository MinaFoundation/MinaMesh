...
pub struct Allow {
    ...
    #[serde(rename = "block_hash_case", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub block_hash_case: Option<Option<models::Case>>,
    #[serde(rename = "transaction_hash_case", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub transaction_hash_case: Option<Option<models::Case>>,
}

impl Allow {
    /// Allow specifies supported Operation status, Operation types, and all possible error statuses. This Allow object is used by clients to validate the correctness of a Rosetta Server implementation. It is expected that these clients will error if they receive some response that contains any of the above information that is not specified here. 
    pub fn new(operation_statuses: Vec<models::OperationStatus>, operation_types: Vec<String>, errors: Vec<models::Error>, historical_balance_lookup: bool, call_methods: Vec<String>, balance_exemptions: Vec<models::BalanceExemption>, mempool_coins: bool) -> Allow {
        Allow {
            operation_statuses,
            operation_types,
            errors,
