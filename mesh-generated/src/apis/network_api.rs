...
pub async fn network_list(configuration: &configuration::Configuration, metadata_request: models::MetadataRequest) -> Result<models::NetworkListResponse, Error<NetworkListError>> {
...
pub async fn network_options(configuration: &configuration::Configuration, network_request: models::NetworkRequest) -> Result<models::NetworkOptionsResponse, Error<NetworkOptionsError>> {
    let local_var_configuration = configuration;
...
pub async fn network_status(configuration: &configuration::Configuration, network_request: models::NetworkRequest) -> Result<models::NetworkStatusResponse, Error<NetworkStatusError>> {
    let local_var_configuration = configuration;
