...
pub async fn search_transactions(configuration: &configuration::Configuration, search_transactions_request: models::SearchTransactionsRequest) -> Result<models::SearchTransactionsResponse, Error<SearchTransactionsError>> {
