...
pub async fn block(configuration: &configuration::Configuration, block_request: models::BlockRequest) -> Result<models::BlockResponse, Error<BlockError>> {
...
pub async fn block_transaction(configuration: &configuration::Configuration, block_transaction_request: models::BlockTransactionRequest) -> Result<models::BlockTransactionResponse, Error<BlockTransactionError>> {
    let local_var_configuration = configuration;
