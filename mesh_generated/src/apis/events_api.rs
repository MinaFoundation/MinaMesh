...
pub async fn events_blocks(configuration: &configuration::Configuration, events_blocks_request: models::EventsBlocksRequest) -> Result<models::EventsBlocksResponse, Error<EventsBlocksError>> {
