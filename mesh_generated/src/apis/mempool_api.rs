...
pub async fn mempool(configuration: &configuration::Configuration, network_request: models::NetworkRequest) -> Result<models::MempoolResponse, Error<MempoolError>> {
...
pub async fn mempool_transaction(configuration: &configuration::Configuration, mempool_transaction_request: models::MempoolTransactionRequest) -> Result<models::MempoolTransactionResponse, Error<MempoolTransactionError>> {
    let local_var_configuration = configuration;
