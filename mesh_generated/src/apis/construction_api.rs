...
) -> Result<models::ConstructionCombineResponse, Error<ConstructionCombineError>> {
...
) -> Result<models::ConstructionDeriveResponse, Error<ConstructionDeriveError>> {
  let local_var_configuration = configuration;
...
) -> Result<models::TransactionIdentifierResponse, Error<ConstructionHashError>> {
  let local_var_configuration = configuration;
...
) -> Result<models::ConstructionMetadataResponse, Error<ConstructionMetadataError>> {
  let local_var_configuration = configuration;
...
) -> Result<models::ConstructionParseResponse, Error<ConstructionParseError>> {
  let local_var_configuration = configuration;
...
) -> Result<models::ConstructionPayloadsResponse, Error<ConstructionPayloadsError>> {
  let local_var_configuration = configuration;
...
) -> Result<models::ConstructionPreprocessResponse, Error<ConstructionPreprocessError>> {
  let local_var_configuration = configuration;
...
) -> Result<models::TransactionIdentifierResponse, Error<ConstructionSubmitError>> {
  let local_var_configuration = configuration;
