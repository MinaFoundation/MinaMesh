...
) -> Result<models::NetworkListResponse, Error<NetworkListError>> {
...
) -> Result<models::NetworkOptionsResponse, Error<NetworkOptionsError>> {
  let local_var_configuration = configuration;
...
pub async fn network_status(
  configuration: &configuration::Configuration,
  network_request: models::NetworkRequest,
) -> Result<models::NetworkStatusResponse, Error<NetworkStatusError>> {
  let local_var_configuration = configuration;
